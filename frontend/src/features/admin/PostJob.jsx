...
export default function PostJob() {
  ...
  const [formData, setFormData] = useState({
    ...
    interviewRounds: [{ type: 'HR', description: '' }],
  });
  ...
  const handleChange = (e) => {
    ...
    if (name === 'skills') {
      ...
      const filtered = PRESET_SKILLS.filter((skill) =>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 text-left">
                ...
                <p className="text-sm text-blue-600 break-all font-mono select-all">
                  {applyLink}
                </p>
              </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                {suggestions.length > 0 && (
                  <ul className="absolute z-10 bg-white border border-gray-200 w-full mt-1 rounded-lg shadow max-h-40 overflow-y-auto">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Only predefined skills are allowed
              </p>
            </div>
            ...
            <div className="space-y-4 pt-4 border-t border-gray-100">
              ...
              <div className="space-y-4">
                {formData.interviewRounds.map((round, index) => (
                  <div
                    key={index}
                    className="p-4 bg-gray-50 border border-gray-200 rounded-xl relative group animate-in fade-in slide-in-from-top-2 duration-300"
                  >
