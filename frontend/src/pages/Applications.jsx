...
export default function Applications() {
  ...
  return (
    <div className="max-w-6xl mx-auto pb-12">
      ...
      <div className="mb-8">
        ...
        <p className="text-neutral-600">Track and manage all your job applications</p>
      </div>
      ...
      <div className="card mb-6">
        ...
        <div className="mt-4 pt-4 border-t border-neutral-200">
          <p className="text-sm text-neutral-600">
            Showing <span className="font-semibold text-neutral-900">{filteredApplications.length}</span> of{' '}
            <span className="font-semibold text-neutral-900">{applications.length}</span> applications
          </p>
        </div>
      </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-neutral-600 mt-3 pt-3 border-t border-neutral-200">
                    <div>
                      ...
                      <span className="font-medium text-neutral-900">{formatDate(app.createdAt)}</span>
                    </div>
                    <div>
                      <span className="text-neutral-500">Updated:</span>{' '}
                      <span className="font-medium text-neutral-900">{formatDate(app.updatedAt)}</span>
                    </div>
                    {app.backlogs && (
                      <div>
                        <span className="text-neutral-500">Backlogs:</span>{' '}
                        <span className="font-medium text-neutral-900">{app.backlogs}</span>
                      </div>
                    )}
                  </div>
                </div>
  ...
  async function handleWithdraw(applicationId) {
    ...
    try {
      const response = await applicationAPI.withdrawApplication(applicationId);
      if (response.success) {
        // Reload applications
        loadApplications();
      }
